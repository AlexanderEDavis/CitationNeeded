...
<html>
    <head>
        ...
        <title>Editing <?php echo($row['bibname']); ?> ~ Citation Needed</title>
    </head>
    <body>
        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
            <header class="mdl-layout__header">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Edit Bibliography: <em> <?php echo($row['bibname']); ?> </em></span>
        ...
        <div class="mdl-card__supporting-text">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
              <input class="mdl-textfield__input" type="text" id="name" name="bibname" value="<?php echo($row['bibname']); ?>"></input>
