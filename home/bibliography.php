                        ...
                        <tbody>
                            ...
                            while($row = mysqli_fetch_assoc($refSql_getRef)) {?>
                                <tr>
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric"><a href="../home/viewref?rid=<?php echo($row['rid']); ?>"><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">View Citations</button></a></td>
